                      ...
                      float collisionRadius, bool isVisible)
{
    ...
    cubeData.triangleBufferData.size = 6 * 6 * 6;// 6 sides * 6 vertices * 6 GLfloats (pos + norm)
    cubeData.triangleBufferData.stride = 6;
    cubeData.triangleBufferData.positionOffset = 0;
    cubeData.triangleBufferData.normalOffset = 3;
    return cubeData;
}
